...
export interface MainHeaderSearchSliderDesktopProps {
  open: boolean;
  onClose: () => void;
}
...
/**
 * @author
 * @function @MainHeaderSearchSliderDesktop
 **/

export const MainHeaderSearchSliderDesktop: FC<
  MainHeaderSearchSliderDesktopProps
> = (props) => {
